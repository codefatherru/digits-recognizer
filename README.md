...
в dataset/mnist_train.csv лежит плоская таблица из строк "Y число" + 784 значения 0-255 
...
принимает на вход ч\б изображние 168х168, инвертирует в 28 на 28 и далее в вектор 784
